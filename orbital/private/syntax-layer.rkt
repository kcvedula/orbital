...
(module+ test
  ...
  ; Test fragment atom and bond counts
  ...
  ; Test basic molecular construction
  (define water
    (molecule water
              (atoms [O O] [H1 H] [H2 H])
              (bonds [O H1 1] [O H2 1])))
  ...
  ; Test more complex fragment combinations
  (define ethyl
    (fragment ethyl
              (atoms [C1 C] [C2 C] [H1 H] [H2 H] [H3 H] [H4 H] [H5 H])
              (bonds [C1 C2 1] [C1 H1 1] [C1 H2 1] [C1 H3 1] [C2 H4 1] [C2 H5 1])
  ...
  ; Build acetic acid by combining methyl and carboxyl
  ...
  ; Check that acetic acid has the right structure                    
